# -*- coding: utf-8 -*-
"""בונה את Areo Workspace | סיכונים מתוך התבנית וקובץ המרשם, בלי לקרוא את התבנית להקשר.

שימוש:
  python3 build_risk_report.py --data risk-register.json --template assets/risk-report-template.html \
...
def main():
    ...
    print("מצב גישה: %s. מסמכים עם קישור חי: %d מתוך %d. נגזרו כעת: %d"
