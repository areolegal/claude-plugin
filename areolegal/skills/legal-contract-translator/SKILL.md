...
- אין מפתח → הצע הפעלה דרך הכלי `activate` או הרכיב `areolegal-setup`. מנוי לא פעיל → מסור את הודעת החידוש. שגיאת תקשורת → הסבר שהשירות דורש סביבה עם גישה ל-AreoLegal.
